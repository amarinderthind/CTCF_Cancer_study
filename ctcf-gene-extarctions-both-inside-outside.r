...
setwd('/home/singh/Dropbox/Amarinder/Amarinder_main_projects/CTCF_motif_AT/2024-ctcf-dragen-additional-samples/Step1.b-extraction-of-loops-gene-list/')

```

```{r}

## may update this with supplimentry file data #GSE63525_NHEK_HiCCUPS_looplist_with_motifs 2
## This data has information of motif sequence, can be used to study the patterns of motif changes
## HOWVER, MAKE SURE THEY ARE FROM HG38 REF GENOME, OTHERWISE LIFTOVER

motif_1806_hg38 <- read.delim("/home/singh/Dropbox/Amarinder/Amarinder_main_projects/CTCF_motif_AT/2024-ctcf-dragen-additional-samples/motifs_with_loops_sorted_hg38_1806.bed", header=FALSE)
...
#step1 # separate the 5prime-motif site from 3primemotif (will end up in 903/1806) entries for each
